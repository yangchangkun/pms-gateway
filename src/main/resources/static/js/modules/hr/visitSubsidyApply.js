...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/hr/visitSubsidy/init",
        data: {},
        success: function(r){
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=hr_visit_subsidy",
    ...
    methods: {
        ...
        saveEntity: function(){
            ...
            var url = "app/hr/visitSubsidy/add";
        ...
        toList:function(){
            openWin("../hr/visitSubsidyList.html");
        },
        ...
        getDiffDays:function(tag){
            if(tag=="travel"){
                if(!isBlank(vm.entity.travelStartDay) && !isBlank(vm.entity.travelEndDay)){
                    var diff = dateDiff(vm.entity.travelStartDay, vm.entity.travelEndDay);
                    vm.entity.travelDays = diff;
                }
            } else if(tag=="subsidy"){
                if(!isBlank(vm.entity.subsidyStartDay) && !isBlank(vm.entity.subsidyEndDay)){
                    var diff = dateDiff(vm.entity.subsidyStartDay, vm.entity.subsidyEndDay);
                    vm.entity.subsidyDays = diff;
                }
            }
        },
                ...
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            ...
                            vm.entity.travelStartDay = day;
                            vm.getDiffDays("travel");
                        },
                        fallback:function(){
                            vm.entity.travelStartDay = "";
                        }
                    });
            } else if(tag=="entity.travelEndDay"){
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        title: '时间选择',
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value;
                            vm.entity.travelEndDay = day;
                            vm.getDiffDays("travel");
                        },
                        fallback:function(){
                            vm.entity.travelEndDay = "";
                        }
                    });
            } else if(tag=="entity.subsidyStartDay"){
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        title: '时间选择',
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value;
                            vm.entity.subsidyStartDay = day;
                            vm.getDiffDays("subsidy");
                        },
                        fallback:function(){
                            vm.entity.subsidyStartDay = "";
                        }
                    });
            } else if(tag=="entity.subsidyEndDay"){
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        title: '时间选择',
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value;
                            vm.entity.subsidyEndDay = day;
                            vm.getDiffDays("subsidy");
                        },
                        fallback:function(){
                            vm.entity.subsidyEndDay = "";
                        }
                    });
            }
