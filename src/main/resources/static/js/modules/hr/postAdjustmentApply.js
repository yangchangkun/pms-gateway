...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/hr/postAdjustment/init",
        data: {},
        success: function(r){
...
function loadCcStaffList(){
    ...
    var param = {
        businessType : 'hr_post_adjustment',
        proId : '',
        days : ''
    }
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=hr_post_adjustment",
    ...
    methods: {
        ...
        saveEntity: function(){
            ...
            var url = "app/hr/postAdjustment/add";
        ...
        toList:function(){
            openWin("../hr/postAdjustmentList.html");
        },
                ...
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            ...
                            vm.entity.adjustmentDate = day;
                        },
                        fallback:function(){
                            vm.entity.adjustmentDate = "";
                        }
                    });
            }
