...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/hr/leaveApply/init",
        data: {},
        success: function(r){
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=hr_leave_apply",
    ...
    methods: {
        ...
        toList:function(){
            openWin("../hr/leaveApplyList.html");
        },
