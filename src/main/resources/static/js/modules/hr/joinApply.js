...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/hr/joinApply/init",
        data: {},
        success: function(r){
                ...
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            ...
                            vm.entity.officialDate = day;
                        },
                        fallback:function(){
                            vm.entity.officialDate = "";
                        }
                    });
            }
