...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/adm/sealApply/init",
        data: {},
        success: function(r){
...
function contactChoiceCallback (userObj){
    if(vm.contactChoiceType=='1'){
        vm.entity.useUserId = userObj.userId;
        vm.entity.useUserName = userObj.name;
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=adm_seal_apply",
        ...
        contactChoiceType: '0', //联系人选择类型 0 抄送人员，1 印章使用人
    },
            ...
            if(tag=="entity.applyDate"){
                ...
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value;
                            vm.entity.borrowDate = day;
                        },
                        fallback:function(){
                            vm.entity.borrowDate = "";
                        }
                    });
            } else if(tag=="entity.revertDate"){
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        title: '时间选择',
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value;
                            vm.entity.revertDate = day;
                        },
                        fallback:function(){
                            vm.entity.revertDate = "";
                        }
                    });
            }
