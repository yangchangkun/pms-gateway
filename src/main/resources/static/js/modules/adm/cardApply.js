...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/adm/cardApply/init",
        data: {},
        success: function(r){
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=adm_card_apply",
