...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/attend/overtime/init",
        data: {},
        success: function(r){
...
function loadCcStaffList(){
    ...
    var param = {
        businessType : 'attendance_overtime',
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=attendance_overtime",
    ...
    methods: {
        ...
        saveEntity: function(){
            ...
            var url = "app/attend/overtime/add";
            $.ajax({
                url: baseURL + url,
                type: "POST",
        ...
        toList:function(){
            openWin("../attendance/overTimeList.html");
        },
        ...
        datePickerChange: function(ele, fmt, tag, idx){
            ...
            if(tag=="entity.startTime"){
                var iosSelect = new IosSelect(4,
                    [yckYearData, yckMonthData, yckDateData, yckHourData],
                    {
                        title: '时间选择',
                        itemHeight: 35,
