...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/attend/travel/init",
        data: {},
        success: function(r){
...
function loadCcStaffList(){
    ...
    var param = {
        businessType : 'attendance_travel',
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=attendance_travel",
    ...
    methods: {
        ...
        toList:function(){
            openWin("../attendance/travelList.html");
        },
                ...
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                            ...
                            vm.entity.startDay = day;
                        },
                        fallback:function(){
                            vm.entity.startDay = "";
                        }
                    });
            } else if(tag=="entity.endDay"){
                var iosSelect = new IosSelect(3,
                    [yckYearData, yckMonthData, yckDateData],
                    {
                        title: '时间选择',
