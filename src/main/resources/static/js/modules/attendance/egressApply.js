...
function init(){
    ...
    $.ajax({
        type: "POST",
        url: baseURL + "app/attend/egress/init",
        data: {},
        success: function(r){
...
var vm = new Vue({
    ...
    data: {
         ...
         * 审批流程图的url
         */
        processInstanceImgUrl:baseURL + "app/common/act/getActivitiProccessDefinitionImage?key=attendance_egress",
    ...
    methods: {
        ...
        toList:function(){
            openWin("../attendance/egressList.html");
        },
                ...
                var iosSelect = new IosSelect(4,
                    [yckYearData, yckMonthData, yckDateData, yckHourData],
                    {
                        ...
                        callback: function (selectOneObj, selectTwoObj, selectThreeObj, selectFourObj) {
                            var day = selectOneObj.value + '-' + selectTwoObj.value + '-' + selectThreeObj.value + ' ' + selectFourObj.value+ ':00';
